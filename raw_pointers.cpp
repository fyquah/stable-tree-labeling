...
struct node_id_t {
  const int stamp;
  const listptr<node_id_t*> parents;

  node_id_t(int stamp, listptr<node_id_t*> parents) :
  ...
  node_id_t(int stamp) :
    stamp(stamp),
    parents(new EmptyList<node_id_t*>()) {
